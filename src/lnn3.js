...
const Varia3 = () => {
  ...
  useEffect(() => {
    startTimer()
    fetch(`http://stawro.xyz/data/03/${qno}`)
    .then(resp => resp.json())
  ...
  const Submitt1 = (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall1/03",{value1, qno})
    .then(res => {
  ...
  const Submitt2 = (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall2/03",{value2, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
  ...
  const Submitt3 = async (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall3/03",{value3, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
    ...
    const Submitt4 = (e) => {
      e.preventDefault();
      axios.post("http://stawro.xyz/vall4/03",{value4, qno})
      .then(res => {
        if(res.data.Status === "200") {
          True()
        }else{
