...
const Varia8 = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://stawro.xyz/data/08/${qno}`)
    .then(resp => resp.json())
  ...
  const Block = async (e) => {
    axios.post("http://stawro.xyz/vall4/08",{value4, qno})
  }
  ...
  const Submitt1 = (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall1/08",{value1, qno})
    .then(res => {
  ...
  const Submitt2 = (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall2/08",{value2, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
  ...
  const Submitt3 = async (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall3/08",{value3, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
