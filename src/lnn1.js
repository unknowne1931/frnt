...
const Varia = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://stawro.xyz/data/${qno}`)
    .then(resp => resp.json())
  ...
  const Submitt1 = (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall1",{value1, qno})
    .then(res => {
  ...
  const Submitt2 = (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall2",{value2, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
  ...
  const Submitt3 = async (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall3",{value3, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
    ...
    const Submitt4 = (e) => {
      e.preventDefault();
      axios.post("http://stawro.xyz/vall4",{value4, qno})
      .then(res => {
        if(res.data.Status === "200") {
          True()
        }else{
