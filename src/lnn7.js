...
const Varia7 = () => {
  ...
  const Exit = () =>{
    axios.post("http://stawro.xyz/eleminate",{email, IP, qno, way})
          .then(res => {
  ...
  useEffect(() => {
    ...
    fetch(`http://stawro.xyz/data/07/${qno}`)
    .then(resp => resp.json())
    ...
    fetch(`http://stawro.xyz/validd/${email}`)
      .then(res => res.json())
  ...
  const Block = async () => {
    const response = await fetch(`http://stawro.xyz/way01/put/${wayy._id}`, {
          method: 'PUT',
          headers: {
  ...
  const Submitt1 = (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall1/07",{value1, qno})
    .then(res => {
  ...
  const Submitt2 = (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall2/07",{value2, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
  ...
  const Submitt3 = async (e) => {
    e.preventDefault();
    axios.post("http://stawro.xyz/vall3/07",{value3, qno})
    .then(res => {
      if(res.data.Status === "200") {
        True()
      }
    ...
    const Submitt4 = (e) => {
      e.preventDefault();
      axios.post("http://stawro.xyz/vall4/07",{value4, qno})
      .then(res => {
        if(res.data.Status === "200") {
          True()
        }else{
