...
const Addprizes = () => {
    ...
    useEffect(() => {
        ...
        fetch("http://stawro.xyz/amount/dataLength")
        .then(res => res.json())
    ...
    const handleSubmitt = async (e) => {
        e.preventDefault();
        try {
          const response = await fetch('http://stawro.xyz/gif/data', {
            method: 'POST',
            headers: {
      ...
      const Subbbit = (e) =>{
        e.preventDefault();
        axios.post("http://stawro.xyz/amount/data/fix" , {email, amount})
        .then(res => {
      ...
      const Subbbitupdate = (e) => {
        e.preventDefault();
        axios.put(`http://stawro.xyz/amount/data/put/${email}`, {amount})
        .then(res => {
          if(res.data.Status === "OK"){
            window.location.href = '/payment'
          }
